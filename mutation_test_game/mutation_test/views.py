...
def diff_2(request,bangou=0):
    ...
    if request.method == 'POST':
        ...
        output_string, killper, kill_status_record = AssertCode_Processer2.AssertCode([("12234"), ("214124")])
        # print(output_string)
        # print(output_string, killper)
...
def diff_3(request, bangou=0):
    ...
    if request.method == 'POST':
        ...
        output_string, killper, kill_status_record = AssertCode_Processer3.AssertCode([("12234"), ("214124")])
        # print(output_string)
        # print(output_string, killper)
